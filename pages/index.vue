...
export default {
  ...
  async mounted () {
    let response
        this.years = await axios.get('http://27.254.62.17:9008/show_data_year',{}).then(function (res) {
            response = res.data
...
methods: {
    ...
    async getcourier(){
    let response
    this.courier = await axios.get('http://27.254.62.17:9008/get_data_all_courier/'+this.year_input,{}).then(function (res) {
            response = res.data
            console.warn('response success')
        }).catch(function (error) {
            if (error.response) {
    ...
    async getComDetail(){
      ...
      console.log("com:",com)
      this.com_margin = await axios.get('http://27.254.62.17:9008/showDataByCourire/'+this.year_input,{
    ...
    let response
    this.points2 = await axios.get('http://27.254.62.17:9008/showCourier/'+this.year_input,{}).then(function (res) {
            response = res.data
            console.warn('response success')
        }).catch(function (error) {
            if (error.response) {
    ...
    async getstatus(){
      let response
        this.status = await axios.get('http://27.254.62.17:9008/get_data_by_status/'+this.year_input,{}).then(function (res) {
            response = res.data
            console.warn('response success')
        }).catch(function (error) {
            if (error.response) {
